function [sun_rise_set, varargout] = sunRiseSet( lat, lng, UTCoff, JD, PLOT)
...
% Process input
% Remember: JD increments at noon
dateBeg = floor(datenum(1899,12,30,00,00,00)+1721058.5);
nDays = floor(JD) - dateBeg;
% try
