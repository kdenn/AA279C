...
% Sim time parameters
t0 = 0; dt = 1; tf = 60*60; t_arr = (t0:dt:tf)';

% Set options for class
opts = struct();
opts.calc_q_det_flag = 0; % 1 if fictitious meas, 0 if normal meas
opts.corrupt_measurements = 0; % 1 if introducing noise to meas
